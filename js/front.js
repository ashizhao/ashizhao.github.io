...
function stylechange(){
  ...
  if(host == "http://localhost:8888/footer/partners.html"){
    window.alert(in index);
    link.rel = "stylesheet";
    link.href = "../CSS/style.default.css"
  }
  else if(host == "http://localhost:8888/anza_index.html"){
    link.rel = "stylesheet";
    link.href = "../CSS/style.anza.css"
  }
  else if(host == "http://localhost:8888/anf_index.html"){
    link.rel = "stylesheet";
    link.href = "../CSS/style.anf.css"
  }
}
